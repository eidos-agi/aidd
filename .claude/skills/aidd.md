...
4. Name the plugins the surface needs. Mac → `plugins/mac-desktop/`. iPhone → `plugins/iphone/`. iPad → `plugins/ipad/`. Next.js + shadcn → `plugins/nextjs-shadcn/`. Do not collapse them. See `/aidd-plugin`.
